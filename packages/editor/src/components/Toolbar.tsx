...
import { Fragment, type PropsWithChildren, useCallback, useEffect, useMemo } from "react";
import { useEditor, useDraftUndoManager, useDraft } from "../hooks/use-editor-store";
...
export default function Toolbar() {
  ...
  return (
    ...
    >
      ...
      <button
        type="button"
        className={clsx(btnClass, standardBtn, "order-6")}
        onClick={editor.toggleSettingsVisible}
      >
