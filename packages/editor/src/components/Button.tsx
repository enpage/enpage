...
const buttonVariants = cva(
  ...
  ],
  {
    variants: {
      intent: {
        primary: [
          "active:text-upstart-100",
          "focus-visible:outline-upstart-600",
          "group-invalid:text-upstart-100",
          // "group-invalid:border-upstart-200",
          "disabled:text-upstart-50",
          "disabled:border-upstart-50",
          "border-upstart-700/80",
          "bg-upstart-600",
          "active:bg-upstart-600",
          "hover:bg-upstart-700/90",
        ],
        neutral: [
          "border-gray-300",
          "text-gray-700",
    ...
    compoundVariants: [
      {
        ...
        className: [
          ...
          // "from-upstart-600",
          // "to-upstart-500",
          // "hover:from-upstart-700",
          // "hover:to-upstart-500",
          "group-invalid:opacity-50",
          "disabled:opacity-50",
          "disabled:border-upstart-200",
          "transition-opacity",
          "duration-100",
        ],
      },
